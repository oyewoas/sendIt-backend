...
=======
  pool.query('CREATE TABLE IF NOT EXISTS users(id SERIAL PRIMARY KEY, firstname VARCHAR(100) NOT NULL, lastname VARCHAR(100) NOT NULL, othernames VARCHAR(100) NOT NULL, email VARCHAR(100) UNIQUE NOT NULL, username VARCHAR(50) NOT NULL, registered DATE NOT NULL, isAdmin BOOL DEFAULT(false))',
>>>>>>> develop
    () => {
